...
receipt anyone can verify beats a policy anyone can write. We are the community that carries it to
everyone the market will not reach: the nonprofit, the county, the clinic, the classroom, the student.
We implement it, teach it, and prove it, in the open and for free.

## The rule

> **No direct model-to-tool path for consequential actions.**

Before an AI system does anything that matters, it asks. A gate decides — *go ahead · only this far ·
wait for a person · no* — and leaves a signed receipt that holds no private content and that a stranger
can verify offline, without an account and without trusting us.
...
**Declare** a rule · **Decide** an action · **Prove** it with a receipt · **Read** it in your own lens ·
...
coverage, claimed by that system's evidence.
...
Everything conforms to OVERT, runs on your own machines, works without an internet connection, and
costs nothing. Every mark you earn is a receipt on a public chain — the credential is evidence, not a
certificate. Nobody sells you a badge.

*Ship safe AI — never unsafe AI. Get to yes. Stay at yes. Recover to yes. Prove it in ten minutes.
Then bring it, and be counted.*
