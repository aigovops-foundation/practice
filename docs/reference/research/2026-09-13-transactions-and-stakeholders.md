...
- Versions: launch 22 July 2025; quarterly releases 1 Oct 2025, 15 Jan 2026 (voice-agent controls), 15 Apr 2026, 15 Jul 2026 (current; next 15 Oct 2026); July 2026 added coding-agent requirements A008 (secrets leakage) and B010 (secure generated code) (https://www.aiuc-1.com/ — the changelog page cited when this memo was written has since 404'd; the claim itself is unchanged from the 13 Sept 2026 research pass).
